...
function buildPlanSnapshot(payload = {}) {
  ...
  return withChainMeta({
    ...
    deployRatio: payload.deployRatio || '',
    deployRatioPct: payload.deployRatioPct || '',
    entryTemplateId: payload.entryTemplateId || '',
    entryTemplateName: payload.entryTemplateName || '',
    deployCapital: payload.deployCapital || '',
    riskLimitAmount: payload.riskLimitAmount || '',
    riskLimitPct: payload.riskLimitPct || '',
    planMaxRiskAmount: payload.planMaxRiskAmount || '',
    planMaxRiskPct: payload.planMaxRiskPct || '',
    finalTotalQty: payload.finalTotalQty || '',
    finalTotalCost: payload.finalTotalCost || '',
    finalAvgCost: payload.finalAvgCost || '',
    finalDynamicStop: payload.finalDynamicStop || '',
...
function buildRiskReport(snapshot = {}) {
  ...
  return withChainMeta({
    ...
    deployRatio: snapshot.deployRatio || '',
    deployRatioPct: snapshot.deployRatioPct || '',
    entryTemplateId: snapshot.entryTemplateId || '',
    entryTemplateName: snapshot.entryTemplateName || '',
    deployCapital: snapshot.deployCapital || '',
    riskLimitAmount: snapshot.riskLimitAmount || '',
    riskLimitPct: snapshot.riskLimitPct || '',
    planMaxRiskAmount: snapshot.planMaxRiskAmount || '',
    planMaxRiskPct: snapshot.planMaxRiskPct || '',
    finalTotalQty: snapshot.finalTotalQty || '',
    finalTotalCost: snapshot.finalTotalCost || '',
    finalAvgCost: snapshot.finalAvgCost || '',
    finalDynamicStop: snapshot.finalDynamicStop || '',
...
function buildLongArchiveFromReport(report = {}) {
  return withChainMeta({
    ...
    deployRatio: report.deployRatio || '',
    deployRatioPct: report.deployRatioPct || '',
    entryTemplateId: report.entryTemplateId || '',
    entryTemplateName: report.entryTemplateName || '',
    deployCapital: report.deployCapital || '',
    riskLimitAmount: report.riskLimitAmount || '',
    riskLimitPct: report.riskLimitPct || '',
    planMaxRiskAmount: report.planMaxRiskAmount || '',
    planMaxRiskPct: report.planMaxRiskPct || '',
    finalTotalQty: report.finalTotalQty || '',
    finalTotalCost: report.finalTotalCost || '',
    finalAvgCost: report.finalAvgCost || '',
    finalDynamicStop: report.finalDynamicStop || '',
