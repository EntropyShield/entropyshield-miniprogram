...
openTradeRecordEntry() {
  wx.navigateTo({
    url: '/pkgReport/tradeRecord/index?from=planSteady&focus=latest'
  });
},

openRiskReportEntry() {
  wx.navigateTo({
    url: '/pkgReport/riskReport/index?from=planSteady&focus=latest'
  });
},

openLongArchiveEntry() {
  wx.navigateTo({
    url: '/pkgReport/longArchive/index?from=planSteady&focus=latest'
  });
},

openMainchainOverviewEntry() {
  wx.navigateTo({
    url: '/pkgService/mainchainOverview/index?from=planSteady&focus=latest'
  });
},
